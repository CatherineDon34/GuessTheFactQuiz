...
//Getting references to HTML elements 
 ...
 function selectAnswer(e) { 
    ...
    Array.from(answerButtons.children).forEach(button => {
        ...
        button.disabled = true; //Disables the use of answer choice buttons after the user has selected an answer choice
    });
...
function showScore() {
    ...
    //Displays final score (number of correctly selected answers) out of the question length of the quiz (currently 10 quiz questions)
    
    if(score < 5) {
        alert("Maybe quizzes aren't your thing...")
    } 
    else {
        alert("Woah, you're impressive!")
    }
}
